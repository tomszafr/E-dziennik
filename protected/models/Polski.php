...
/**
 * This is the model class for table "polski".
 *
 * The followings are the available columns in table 'polski':
 ...
 */
class Polski extends CActiveRecord
{
	public $imie;
	public $nazwisko;
	 ...
	 * @return Polski the static model class
	 */
