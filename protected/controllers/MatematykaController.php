...
class MatematykaController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Matematyka'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Matematyka');
	...
	{
		$model=new Matematyka('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Matematyka']))
			$model->attributes=$_GET['Matematyka'];
	 ...
	 * @return Matematyka the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Matematyka::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Matematyka $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='matematyka-form')
		{
	...
	public function allowTeacher(){
		if(Yii::app()->user->level == 'n' && Yii::app()->user->subjN == 'matematyka') {
			return true;
		} else {
			return false;
		}
