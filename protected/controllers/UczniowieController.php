...
// 			),
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Uczniowie'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Uczniowie');
	...
	{
		$model=new Uczniowie('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Uczniowie']))
			$model->attributes=$_GET['Uczniowie'];
	 ...
	 * @return Uczniowie the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Uczniowie::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Uczniowie $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='uczniowie-form')
		{
